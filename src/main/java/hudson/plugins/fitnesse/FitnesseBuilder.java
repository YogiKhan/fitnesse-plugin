...
public class FitnesseBuilder extends Builder {
    ...
    public static final String NUMBER_OF_THREAD = "numberOfThread";
    ...
    public String getNumberOfThread() {
        return getOption(NUMBER_OF_THREAD, "");
    }

    public String getNumberOfThread(EnvVars environment) {
        return getOption(NUMBER_OF_THREAD, "", environment);
    }
            ...
            if (Boolean.parseBoolean(startFitnesseValue)) {
                return newFitnesseBuilder(
                        ...
                        collectFormData(formData, new String[] { FITNESSE_JDK, JAVA_OPTS, JAVA_WORKING_DIRECTORY, PATH_TO_JAR,
                                PATH_TO_ROOT, FITNESSE_PORT_LOCAL, NUMBER_OF_THREAD,TARGET_PAGE, TARGET_IS_SUITE, HTTP_TIMEOUT, TEST_TIMEOUT,
                                PATH_TO_RESULTS, FITNESSE_ADDITIONAL_OPTIONS }));
            }
            return newFitnesseBuilder(
                    startFitnesseValue,
                    collectFormData(formData, new String[] { FITNESSE_HOST, FITNESSE_PORT_REMOTE, FITNESSE_ENABLE_SSL, NUMBER_OF_THREAD, TARGET_PAGE, TARGET_IS_SUITE,
